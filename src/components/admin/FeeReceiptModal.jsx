...
const T = {
  en: {
    ...
    orgName: companyInfo.name || 'Kuldeep Malik Sports Academy',
    ...
    orgShort: 'Kuldeep Malik Sports Academy',
  ...
  hi: {
    ...
    a4: 'A4',
    thermal: '80mm थर्मल',
    orgName: companyInfo.name || 'कुलदीप मलिक स्पोर्ट्स अकादमी',
    ...
    orgShort: 'कुलदीप मलिक स्पोर्ट्स अकादमी',
